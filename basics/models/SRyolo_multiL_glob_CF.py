...
from .image_encoder_mL_1global_CF import *
...
class Model(nn.Module):
    ...
    def deepcopy(self):
        cls = self.__class__
        kwargs = {name: self.init_params.get(name) for name in self.init_params}
        new_model = cls(**kwargs)
        new_model.load_state_dict(deepcopy(self.state_dict()))
        return new_model
