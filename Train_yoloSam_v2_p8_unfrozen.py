...
from basics.models.SRyolo_SAMP8 import Model #zjq
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str,default='codes/models/SRyolo_SAM_v3_orig_p8.yaml', help='model.yaml path') #yolov5s
    ...
    parser.add_argument('--project', default='outputs_SAM/yoloSAM_v2_P8_unfrozen_RGB/run/train', help='save to project/name')
