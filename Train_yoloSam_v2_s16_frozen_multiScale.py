...
#used for training SRyolo with SAM backbone frozen weights RGB mode SAM's original config (stride 16) and with feature pyramid network
#that gives 128 x 128  size feature maps at detection head
#the result was not good from the beginning and training stopped
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str,default='codes/models/SRyolo_SAM_v3_orig_multiS.yaml', help='model.yaml path') #yolov5s
