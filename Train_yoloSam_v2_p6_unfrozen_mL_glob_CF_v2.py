...
from basics.models.SRyolo_multiL_glob_CF_v3 import Model #zjq
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str,default='codes/models/SRyolo_SAM_v3_orig_multiL_glob_CF_v3.yaml', help='model.yaml path') #yolov5s
    ...
    parser.add_argument('--project', default='outputs_SAM/yoloSAM_v2_p6_multiL_RGBIR_glob_CF_v3/run/train', help='save to project/name')
