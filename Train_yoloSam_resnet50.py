...
from basics.models.SRyolo_resnetbb import Model #zjq
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', default='outputs/outputs_resnet50_128/run/train', help='save to project/name')
