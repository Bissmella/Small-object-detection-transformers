...
from basics.models.image_encoder_mL_global_pooledW import ImageEncoderViT, PatchEmbed, Block, Attention
...
from basics.models.SRyolo_multiL_glob_pooledW import Model #zjq
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str,default='codes/models/SRyolo_SAM_v3_orig_multiL_3glob.yaml', help='model.yaml path') #yolov5s
    ...
    parser.add_argument('--batch-size', type=int, default=6, help='total batch size for all GPUs')    #* default 2
    ...
    parser.add_argument('--project', default='outputs_SAM/yoloSAM_v2_p6_multiL_RGBIR_glob_pooledW/run/train', help='save to project/name')
