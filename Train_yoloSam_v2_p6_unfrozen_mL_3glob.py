...
from basics.models.image_encoder_mL_3global import ImageEncoderViT, PatchEmbed, Block, Attention
...
from basics.models.SRyolo_multiL_3glob import Model #zjq
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', default='outputs_SAM/yoloSAM_v2_p6_multiL_RGBIR_3glob/run/train', help='save to project/name')
