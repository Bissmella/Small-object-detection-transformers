...
def select_device(device='', batch_size=None):
    ...
    s = f'YOLOv5 🚀  torch {torch.__version__} '  # string           #* removed after emoji '{git_describe() or date_modified()}'
...
from basics.models.image_encoder_mL_1global_CF_v2_cross_alt_SCC import PatchEmbed
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    #############################/home/bbahaduri/sryolo/codes/models/SRvedai.yaml
    parser.add_argument('--weights', type=str, default='', help='initial weights path')
    parser.add_argument('--cfg', type=str,default='codes/models/SRyolo_CC.yaml', help='model.yaml path') #yolov5s
    ...
    parser.add_argument('--batch-size', type=int, default=16, help='total batch size for all GPUs')    #* default 2   last 10
    ...
    parser.add_argument('--project', default='outputs/withoutSR_CC/train', help='save to project/name')
