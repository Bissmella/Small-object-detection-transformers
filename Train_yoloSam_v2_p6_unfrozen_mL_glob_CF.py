...
from basics.models.SRyolo_multiL_glob_CF import Model #zjq
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', default='outputs_SAM/yoloSAM_v2_p6_multiL_RGBIR_glob_CF/run/train', help='save to project/name')
