...
def train(hyp, opt, device, tb_writer=None):
    ...
    dataloader, dataset = create_dataloader(train_path, imgsz, batch_size, gs, opt,      #*changed
                                        ...
                                        workers=opt.workers,
                                        image_weights=opt.image_weights, quad=opt.quad, prefix=colorstr('train: '), fold = 'labels08')
    # else:
    ...
    if rank in [-1, 0]:
        ...
        testloader = create_dataloader(test_path, imgsz_test, batch_size, gs, opt,  # testloader     #*changed  batch_size//2
                                    ...
                                    prefix=colorstr('val: '), fold = 'labels08')[0]
        # else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str,default='codes/models/SRvedai8.yaml', help='data.yaml path')
