...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch-size', type=int, default=5, help='total batch size for all GPUs')    #* default 2
    ...
    parser.add_argument('--project', default='run/train_SR/', help='save to project/name')
