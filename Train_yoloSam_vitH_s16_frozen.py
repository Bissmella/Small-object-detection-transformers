...
from basics.models.SRyolo_SAMvitH import Model #zjq
...
def train(hyp, opt, device, tb_writer=None):
    ...
    if pretrained:
        ...
        SAM_weights = torch.load("/home/bbahaduri/sryolo/weights/sam_vit_l_0b3195.pth")
        vit_bb = {}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', default='outputs_SAM/yoloSAM_vitH_s16_frozen_RGB/run/train', help='save to project/name')
    ...
    # Set DDP variables
    opt.world_size = int(os.environ['WORLD_SIZE']) if 'WORLD_SIZE' in os.environ else 1 #2
    opt.global_rank = int(os.environ['LOCAL_RANK']) if 'RANK' in os.environ else -1  #opt.local_rank
