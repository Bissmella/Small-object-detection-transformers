...
from basics.models.SRyolo_multiL_glob import Model #zjq
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str,default='codes/models/SRyolo_SAM_v3_orig_multiL.yaml', help='model.yaml path') #yolov5s
    ...
    parser.add_argument('--project', default='outputs_SAM/yoloSAM_v2_p6_multiL_RGBIR_glob/run/train', help='save to project/name')
