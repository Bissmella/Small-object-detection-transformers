# -*- coding: utf-8 -*-
#SuperYolo with VIT multilevel reversed pyramid
...
from basics.models.image_encoder_mL_2glob_v2 import ImageEncoderViT, PatchEmbed, Block, Attention
...
from basics.models.SRyolo_multiL_2glob_v2 import Model #zjq
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str,default='codes/models/SRyolo_SAM_v3_orig_multiL_2glob_v2.yaml', help='model.yaml path') #yolov5s
    ...
    parser.add_argument('--project', default='outputs_SAM/yoloSAM_v2_p6_multiL_RGBIR_2glob_v2/run/train', help='save to project/name')
