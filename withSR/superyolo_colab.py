...
Original file is located at
    https://colab.research.google.com/drive/1ROKrVXgEdIs8WYkqTYb4rv3zfu2aiIXq
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str,default='/home/bbahaduri/sryolo/codes/models/SRyolo_MF.yaml', help='model.yaml path') #yolov5s
    parser.add_argument('--super', default=True, action='store_true', help='super resolution')
    parser.add_argument('--data', type=str,default='/home/bbahaduri/sryolo/codes/models/SRvedai.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='/home/bbahaduri/sryolo/codes/models/hyp.scratch.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--project', default='/home/bbahaduri/sryolo/outputs/withSR', help='save to project/name')
    ...
    if opt.resume and not wandb_run:  # resume an interrupted run
        ckpt = opt.resume if isinstance(opt.resume, str) else get_latest_run('/home/bbahaduri/sryolo/outputs/withSR/exp2')  # specified or most recent path
    ...
    # Hyperparameters
    opt.project = '/home/bbahaduri/sryolo/outputs/withSR'
    opt.hyp = '/home/bbahaduri/sryolo/codes/models/hyp.scratch.yaml'
    opt.data = '/home/bbahaduri/sryolo/codes/models/SRvedai.yaml'
    opt.save_dir = '/home/bbahaduri/sryolo/outputs/withoutSR/exp2'
    opt.epochs =200
    opt.batch_size = 10
    opt.total_batch_size = 10
